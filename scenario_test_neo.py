...
my_test_scenario = Scenario(name='Test Scenario',
                            num_asteroids=20,
                            ship_states=[
                            {'position': (width//3, height//2), 'angle': 90, 'lives': 3, 'team': 1},
                            {'position': (width*2//3, height//2), 'angle': 90, 'lives': 3, 'team': 2}],
...
score, perf_data = game.run(scenario=my_test_scenario, controllers = [NeoController(), NeoController()]) #, DefensiveCamperController()])
